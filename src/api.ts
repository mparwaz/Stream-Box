...
export const fetchActionMovies = async (page = 1): Promise<Movie[]> => {
  const res = await fetch(`${BASE_URL}/discover/movie?with_genres=28&page=${page}`);
...
export const fetchComedyMovies = async (page = 1): Promise<Movie[]> => {
  const res = await fetch(`${BASE_URL}/discover/movie?with_genres=35&page=${page}`);
...
export const fetchMovies = async (page = 1): Promise<Movie[]> => {
  const res = await fetch(`${BASE_URL}/discover/movie?sort_by=popularity.desc&page=${page}`);
...
export const fetchTvShows = async (page = 1): Promise<Movie[]> => {
  const res = await fetch(`${BASE_URL}/discover/tv?sort_by=popularity.desc&page=${page}`);
...
export const searchMovies = async (query: string, page = 1): Promise<Movie[]> => {
  const res = await fetch(`${BASE_URL}/search/multi?query=${encodeURIComponent(query)}&page=${page}`);
